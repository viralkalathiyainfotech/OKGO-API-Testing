...
//        params.put("bbb", param);
        ...
        //这个RxUtils的封装其实没有必要，只是有些人喜欢这么干，我就多此一举写出来了。。
        //这个RxUtils的封装其实没有必要，只是有些人喜欢这么干，我就多此一举写出来了。。
        return RxUtils.request(HttpMethod.GET, "https://kalathiyainfotechapi.in/api/language", String.class, params, headers);
    }
